...
vi.mock('../../../../../src/components/report/dr-comment-by-types', () => ({__esModule: true, default: () => <div>comments</div>}));
vi.mock('../../../../../src/components/report/dr-interpretation/dr-mutation-by-types', () => ({__esModule: true, default: () => <div>mutations</div>}));

import DRInterpretation from '../../../../../src/components/report/dr-interpretation';
