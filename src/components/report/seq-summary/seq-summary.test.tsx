...
vi.mock('./pango-lineage', async () => {
  const actual = await vi.importActual<any>('./pango-lineage');
  return {
    ...actual,
...
import DownloadConsensus from './download-consensus';
import GeneMutations from './gene-mutations';
import Genotype from './genotype';
import InlineGeneRange from './inline-gene-range';
import MaxMixtureRate from './max-mixture-rate';
import MedianReadDepth from './median-read-depth';
import MinCodonReads from './min-codon-reads';
import MinPositionReads from './min-position-reads';
import MinPrevalence from './min-prevalence';
import MultilineGeneRange from './multiline-gene-range';
import OutbreakInfo from './outbreak-info';
import PangoLineage from './pango-lineage';
import {PrettyPairwiseButton, PrettyPairwiseList} from './pretty-pairwise';
import {SDRMButton, SDRMList} from './sdrm-list';
import Subtype from './subtype';
import ThresholdNomogram from './threshold-nomogram';
...
vi.mock('../../seqreads-threshold-nomogram', () => ({
  __esModule: true,
