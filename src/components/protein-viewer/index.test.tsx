...
import ProteinViewer from './index';
...
vi.mock('../../utils/colors', () => ({getColorInt: () => 0}));
vi.mock('./residue-layer', () => ({default: () => <div data-testid="residue-layer"/>}));
vi.mock('./camera-controller', () => ({default: () => <div data-testid="camera-controller"/>}));
