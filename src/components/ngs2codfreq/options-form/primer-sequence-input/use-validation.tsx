 ...
 *
 * @param primers - Array of primer sequence definitions containing FASTA-like
 *   headers, sequence strings and primer types.
...
export default function useValidation(primers: PrimerSeq[]) {
  ...
  React.useEffect(() => {
    ...
    const headerCounter: Record<string, number> = {};
