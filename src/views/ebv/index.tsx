...
/**
 * Layout component wrapping EBV views with configuration and styles.
 *
...
/**
 * Generate the EBV route subtree.
 *
 * @param options - {@link EbvRoutesOptions} for path and configuration.
 * @returns A {@link Route} element describing EBV routes.
 */
export default function ebvRoutes({
  pathPrefix = 'ebv/',
